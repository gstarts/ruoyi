...
/**
 * 进出场查询对象 g_feedback_log
 *
 * @author qishuai
 * @date 2020-01-02
 */
@ApiModel("用户实体")
public class GFeedbackLog extends BaseEntity
{
    ...
    @ApiModelProperty("采集到所有数据0:采集未发送81,1:81发送完成未接到82回复，2:接收到82回复未执行，3执行完成")
