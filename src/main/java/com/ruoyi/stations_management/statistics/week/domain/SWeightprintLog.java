package com.ruoyi.stations_management.statistics.week.domain;
 ...
 * @date 2020-05-20
 */
public class SWeightprintLog extends BaseEntity
{
    ...
    public String toString() {
        return new ToStringBuilder(this,ToStringStyle.MULTI_LINE_STYLE)
            ...
            .append("calculateNum", getCalculateNum())
            ...
            .append("receiptCompany", getReceiptCompany())
            .append("flow", getFlow())
            .append("calculateName", getCalculateName())
            .append("remarke", getRemarke())
            .append("mjTime", getMjTime())
